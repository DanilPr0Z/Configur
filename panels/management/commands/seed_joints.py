...
JOINTS = [
    ...
    {"code": "G",  "name": "Стык с коробкой (НАРУЖУ)",            "offset_mm":  50.1,  "price_per_meter": 800.0, "profile_article": "ХДФ 3,2 ММ","profile_count": 0.0},
    {"code": "H",  "name": "Стык с коробкой (ВНУТРЬ)",           "offset_mm":  58.5,  "price_per_meter": 800.0, "profile_article": "ХДФ 3,2 ММ","profile_count": 0.0},
    ...
    {"code": "P",  "name": "Декоративная фрезеровка (узел P)",    "offset_mm":   0.0,  "price_per_meter": 500.0, "profile_article": "",          "profile_count": 0.0},
